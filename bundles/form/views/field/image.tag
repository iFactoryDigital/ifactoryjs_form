<field-image>
  <field ref="field" is-input={ true } class="field-container-inner" on-container-class={ onFieldClass } is-multiple={ true } get-fields={ getFields } get-element={ getElement } on-col={ onCol } on-input={ onInput }>
    <yield to="body">
      <div class="form-group">
        ...
        <upload name={ opts.field.uuid } multi={ opts.field.multiple } image={ opts.data.value } col={ opts.field.col } show-type={ opts.field.input } />
      </div>
    </yield>
